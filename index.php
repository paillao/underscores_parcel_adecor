...
?>
	...
	<div class="grid__cell grid__cell-c4-r2 grid__cell--padded">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e("Skip to content", "underscores_parcel"); ?></a>
		  ...
		  <div class="site-info">
			  <a href="https://paillao.com" target="_blank">website by: @paillao</a>		  
		</div>
	  </div>
	</div>
				  ...
				  while ($the_query->have_posts()):
					 ...
					 <div class="content__item" id="item-1">
	  					...
	  					<h2 class="content__item-heading oh">
							<span class="oh__inner"><?php echo wp_strip_all_tags( the_title() ); ?></span>
	  					</h2>
	  					<p class="content__item-text">
	  					<?php echo wp_strip_all_tags( get_the_content() ); ?>
	  					</p>
	  					<a class="content__item-link oh" href="<?php bloginfo( 'url' ) ?>/cotizar"><span class="oh__inner">Cotizar</span></a>
	  					<nav class="slide-nav">
